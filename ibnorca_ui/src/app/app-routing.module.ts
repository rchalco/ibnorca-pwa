...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      ...
      ).then((m) => m.ProgramaAuditoriaPageModule),
  },
  {
    ...
    loadChildren: () =>
      ...
      ).then((m) => m.MasterElaboracionAuditoriaPageModule),
  },
  {
    path: 'ivo',
    loadChildren: () =>
      import('./pages/test/ivo/ivo.module').then((m) => m.IvoPageModule),
  },
  {
    path: 'ruben',
    loadChildren: () =>
      import('./pages/test/ruben/ruben.module').then((m) => m.RubenPageModule),
  },
  {
    path: 'myke',
    loadChildren: () =>
      import('./pages/test/myke/myke.module').then((m) => m.MykePageModule),
  },
  {
    path: 'list-ciclos',
    loadChildren: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      ...
      ).then((m) => m.PanelDocumentosPageModule),
  },
  {
    ...
    loadChildren: () =>
      ...
      ).then((m) => m.RegistroSolicitudServicioPageModule),
  },
];
